...
namespace Cypher
{
    ...
    public class PeHeaderReader
    {
        ...
        public PeHeaderReader(string filePath)
        {
            ...
            using (FileStream stream = new FileStream(filePath, System.IO.FileMode.Open, System.IO.FileAccess.ReadWrite))
            {
        ...
        public void Write<T>(BinaryReader reader)
        {
            byte[] bytes = reader.ReadBytes(Marshal.SizeOf(typeof(T)));GCHandle.
            writer.Write(bytes);
        }
